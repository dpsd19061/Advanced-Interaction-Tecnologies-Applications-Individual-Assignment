...
--> Εργασία για το μάθημα Προηγμένες Tεχνολογίες Αλληλεπίδρεσης και Eφαρμογές που αφορά την ανάπτυξη εφαρμογών στο περιβάλλον της Processing.

# Summary

--> Στην παρακάτω αναφορά παρατίθενται η πρόοδς μου στις εργασίες για το μάθημα Προηγμένες τεχνολογίες Αλληλεπίδρεσης και εφαρμογές οι οποίες έχουν αναπτυχθεί με την γλώσσα προγραμματισμού Processing. Οι πρεισσότερες εργασίες αφορούν τη χρήση της βιβλοθήκης video, τουτέστιν εφαρμογές αλληλεπίδρασης με κάμερα, εφαρμογές με επιφάνεια πολυαφής και εφαρμογές με την κάμερα Kinect.
